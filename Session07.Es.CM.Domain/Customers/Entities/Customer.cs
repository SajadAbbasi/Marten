using Es.Framework;
using Session07.Es.CM.Domain.Customers.DomainEvents;
using Session07.Es.CM.Domain.Customers.ValueObjects;
using System;
using System.Collections.Generic;

namespace Session07.Es.CM.Domain.Customers.Entities
{
